...
#ifndef INTARNA_PREDICTORMFE2DMULTISEED_H
#define INTARNA_PREDICTORMFE2DMULTISEED_H
 ...
 *
 */
class PredictorMfe2dMultiSeed: public PredictorMfe2dMulti {

protected:

	//! matrix type to hold the mfe energies for interaction site starts
	typedef PredictorMfe2dMulti::E2dMatrix E2dMatrix;
...
public:
	 ...
	 * data cleanup
	 */
	virtual ~PredictorMfe2dMultiSeed();
...
protected:
	...
	using PredictorMfe2dMulti::energy;

	//! access to the output handler of the super class
	using PredictorMfe2dMulti::output;
